...
![Basic Radar Chart](https://github.com/Erik3010/radar-chart/blob/master/preview/basic.png?raw=true)
There are two types of charts in this library. There are Basic and Pie chart.

### Basic Chart

![Pie Radar Chart](https://github.com/Erik3010/radar-chart/blob/master/preview/pie.png?raw=true)
